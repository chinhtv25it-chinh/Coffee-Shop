...
# ☕ COFFEE SHOP
### 🚀 Hệ Thống Quản Lý & Bán Hàng Cà Phê Mạng Đa Luồng (Client - Server)
...
* 🌐 **Server-Side:** Sử dụng kiến trúc đa luồng (`Multi-threading`) để chấp nhận nhiều kết nối đồng thời qua `ClientHandler`. Tầng `dao` đảm nhận nhiệm vụ truy vấn cơ sở dữ liệu MySQL tách biệt hoàn toàn.
...
| **Database** | `MySQL Connector/J` | Driver kết nối hệ quản trị cơ sở dữ liệu MySQL qua JDBC. |
